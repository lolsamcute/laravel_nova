            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h1 class="mb-sm-0 font-size-18">Mailing List</h1>
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li>
                                            ...
                                            <select class="form-control" name="currency">
                                                <option>select your recipient</option>
                                                <option selected>Kreator</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <a href="/app/mailing/create" class="btn btn-primary">+ Compose Mail</a>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        (1/7) Welcome to KreateSell [Kreator’s first name]🥳
                                    </td>
                                    <td>
                                        All Kreators
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a class="dropdown-item" href="/app/mailing/preview"><img
                                                ...
                                                <a class="dropdown-item" href="/app/mailing/edit"><img
                                                        src="/edit.png" height="30" width="30">Edit</a>




                                                <a class="dropdown-item" href="mailto:"><img src="/send.png"
                                                        height="30" width="30">Send
                                                </a>
                                            </ul>
                                        </div>

                                        @include('pages.mailing.modals.recipients')
                                    </td>
