                                    ...
                                    <div class="">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div>
                                                        ...
                                                        <p class="text-muted font-size-15"><img height="30"
                                                                width="30"
                                                                src="/category.png">{{ $blog->Category }}</p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mt-4 mt-sm-0">
                                                        <p class="text-muted font-size-15"><img height="30"
                                                                width="30"
                                                                src="/time.png">{{ \Carbon\Carbon::parse($blog->CreatedAt)->diffForHumans() }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mt-4 mt-sm-0">
                                                        <p class="text-muted font-size-15"><img height="30"
                                                                width="30"
                                                                src="/time.png">{{ $blog->ReadMinutes }} mins read
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="row">
                                                        ...
                                                        <form id="likeForm" method="POST"
                                                            ...
                                                            <p class="text-muted font-size-15">
                                                                <a class="button" href="javascript:void(0);"
                                                                    onclick="submitLikeForm()">
                                                                    <img height="30" width="30"
                                                                        src="/like.png">{{ $blog->LikeCount }}
                                                                </a>
                                                            </p>
                                                        </form>

                                                        @include('pages.blog.likeScript')
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mt-4 mt-sm-0">
                                                        <p class="text-muted font-size-15"><img height="30"
                                                                width="30"
                                                                src="/comment.png">{{ $countComments ?? '0' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <form method="POST" action="/app/comment/{{ $blog->Id }}">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="commentmessage-input" name="Contents" placeholder="Write your Comment"
                                                            rows="3"></textarea>
                                                    </div>
                                        ...
                                        <div class="mt-8">
                                            ...
                                            @foreach ($latestBlog as $item)
                                                <div class="list-group list-group-flush">
                                                    ...
                                                    <a href="/app/blogdetails/{{ $item->Id }}"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                ...
                                                                <p class="mb-0 text-truncate">
                                                                    {{ \Carbon\Carbon::parse($item->CreatedAt)->diffForHumans() }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </a>
