                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <a href="">
                            ...
                            <h4 class="text-center">{{ $edit->Title }}</h4><br>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="/app/blog/editPost/{{ $edit->Id }}"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="text" name="Title" class="form-control"
                                                id="floatingInput" value="{{ $edit->Title }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <?php
                                            $selectedCategories = explode(',', $edit->Category ?? '');
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input name="Tags" class="form-control"
                                                id="choices-text-unique-values" type="text"
                                                value="{{ $edit->Tags }}" class="custom class" />
                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="fallback">
                                                                <input name="Thumbnail"
                                                                    value="{{ $edit->Thumbnail }}" type="file">
                                                            </div>
                                                            <div class="dz-message needsclick">
                                                                <div class="mb-3">
                                                                    <i
                                                                        class="display-4 text-muted bx bx-cloud-upload"></i>
                                                                </div>
                                                    ...
                                                    <div class="text-center mt-4">
                                                        <p style="color: red">Allowed Files: PNG, JPG | Maximum file
                                                            size:
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <textarea id="basicpill-address-input" name="UrlSlug" class="form-control" rows="3">{{ $edit->UrlSlug }}</textarea>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <textarea name="Description" id="ckeditor-classic">{!! $edit->Description !!}</textarea>
