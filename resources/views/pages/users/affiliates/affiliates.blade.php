                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <form method="GET" action="/filterAffiliatesDashboard">
                                ...
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li>
                                        ...
                                        @if ($filter === 'active' ? ' active' : '')
                                            <a href="{{ route('affiliates.index', ['filter' => 'active']) }}"
                                                class="form-control btn btn-primary">
                                                Active
                                            </a>
                                        @else
                                    ...
                                    <li>
                                        ...
                                        @if ($filter === 'deactivated' ? ' active' : '')
                                            <a href="{{ route('affiliates.index', ['filter' => 'deactivated']) }}"
                                                class="form-control btn btn-primary">
                                                Deactivated
                                            </a>
                                        @else
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        @if ($user->IsActive == true)
                                                            <a class="dropdown-item"
                                                                href="/affiliateDeactivate/{{ $user->Id }}"><img
                                                                    src="/deactivate.png" height="30"
                                                                    width="30">Deactivate</a>
                                                        @else
                                                            <a class="dropdown-item"
                                                                href="/affiliateActivate/{{ $user->Id }}"><img
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="/affiliateView/{{ $user->Id }}"><img
