                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <form method="GET" action="/filterUserDashboard">
                    ...
                    <div class="table-responsive mb-4">
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                @foreach ($userGrossSales as $user)
                                    @if (
                                        ($filter == 'active' && $user->IsActive == '1') ||
                                            ($filter == 'deactivated' && !$user->IsActive == '2') ||
                                            $filter == 'all')
                                        <tr>
                                            ...
                                            <td>
                                                {{ Str::limit($user->FullName ?? 'N/A', 30) }}

                                                @if ($user->IsAffiliate)
                                                    <span class="badge bg-success-subtle text-primary">
                                                        <i class="fas fa-link"></i>Aff</span>
                                                @endif
                                            </td>

                                            <td>{{ $user->Email ?? 'N/A' }}</td>
                                            <td>{{ $user->PhoneNumber ?? 'N/A' }}</td>
                                            <td>NGN{{ number_format($user->gross_sales, 2) }}</td>
                                            <td>{{ \Carbon\Carbon::parse($user->CreatedAt)->format('M jS Y, g:i A') }}
                                            </td>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @if ($user->IsActive == '1')
                                                            <a class="dropdown-item"
                                                                href="/usersDeactivate/{{ $user->Id }}"><img
                                                                    src="/deactivate.png" height="30"
                                                                    width="30">Deactivate</a>
                                                        @else
                                                            <a class="dropdown-item"
                                                                href="/usersActivate/{{ $user->Id }}"><img
