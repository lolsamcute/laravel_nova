                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <form method="GET" action="/filterKreatorsDashboard">
                                ...
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li>
                                        ...
                                        @if ($filter === 'active' ? ' active' : '')
                                            <a href="{{ route('kreators.index', ['filter' => 'active']) }}"
                                                class="form-control btn btn-primary">
                                                Active
                                            </a>
                                        @else
                                    ...
                                    <li>
                                        ...
                                        @if ($filter === 'deactivated' ? ' active' : '')
                                            <a href="{{ route('kreators.index', ['filter' => 'deactivated']) }}"
                                                class="form-control btn btn-primary">
                                                Deactivated
                                            </a>
                                        @else
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @if ($user->IsActive == '1')
                                                            <a class="dropdown-item"
                                                                href="/kreatorsDeactivate/{{ $user->Id }}"><img
                                                                    src="/deactivate.png" height="30"
                                                                    width="30">Deactivate</a>
                                                        @else
                                                            <a class="dropdown-item"
                                                                href="/kreatorsActivate/{{ $user->Id }}"><img
