                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <a href="">
                            ...
                            <h6 class="text-center">See below all store transactions.</h6>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <span class="text-muted mb-3 lh-1 d-block text-truncate">Successful</span>
                                            <h4 class="mb-3">
                                                <span class="counter-value"
                                                    data-target="{{ $countSuccessful }}">{{ $countSuccessful }}</span>
                                            </h4>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <h4 class="mb-3">
                                                <span class="counter-value"
                                                    data-target="{{ $countPending }}">{{ $countPending }}</span>
                                            </h4>
                                        </div>
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block text-truncate">Abandoned</span>
                                            <h4 class="mb-3">
                                                <span class="counter-value"
                                                    data-target="{{ $countAbandoned }}">{{ $countAbandoned }}</span>
                                            </h4>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <h4 class="mb-3">
                                                <span class="counter-value"
                                                    data-target="{{ $countFailed }}">{{ $countFailed }}</span>
                                            </h4>
                                        </div>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <ol class="breadcrumb m-0">
                                    <li>
                                        ...
                                        <a href="{{ route('transactions', ['filter' => 'all']) }}"
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('transactions', ['filter' => 'successful']) }}"
                                            class="form-control btn {{ $filter === 'successful' ? 'btn-primary' : 'btn-secondary' }}">
                                            Successful
                                        </a>
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('transactions', ['filter' => 'pending']) }}"
                                            class="form-control btn {{ $filter === 'pending' ? 'btn-primary' : 'btn-secondary' }}">
                                            Pending
                                        </a>
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('transactions', ['filter' => 'abandoned']) }}"
                                            class="form-control btn {{ $filter === 'abandoned' ? 'btn-primary' : 'btn-secondary' }}">
                                            Abandoned
                                        </a>
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('transactions', ['filter' => 'failed']) }}"
                                            class="form-control btn {{ $filter === 'failed' ? 'btn-primary' : 'btn-secondary' }}">
                                            Failed
                                        </a>
                                    ...
                                    @if (
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                {{ Str::limit($trans->Fullname, 15) }}
                                            </td>
                                            <td> {{ Str::limit($trans->Email, 10) }}
                                            </td>
                                            <td>

                                                {{ Str::limit($trans->ProductName, 15) }}
                                            ...
                                            <td>NGN{{ number_format($trans->Total, 2) }}</td>

                                            <td>
                                                @if ($trans->CardType == 'paystack' || $trans->CardType == 'paystackBank')
                                                    <img src="/paystack.png" height="50" width="150"
                                                        alt="Paystack">
                                                @elseif ($trans->CardType == 'flutterwave')
                                                    <img src="/flutter.png" height="50" width="150"
                                                        alt="Flutterwave">
                                                @elseif ($trans->CardType == 'paypal')
                                                    <img src="/paypal.png" height="50" width="150"
                                                        alt="Paypal">
                                                @elseif ($trans->CardType == 'stripe')
                                                    <img src="/stripe.png" height="50" width="150"
                                                        alt="Stripe">
                                                @else
                                                    No Type
                                                @endif
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($trans->DateCreated)->format('M jS Y, g:i A') }}
                                            </td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @if ($trans->Status == 'Successful')
                                                        <a class="badge bg-success-subtle text-primary">Successful</a>
                                                    @elseif ($trans->Status == 'Abandoned')
                                                        <a class="badge bg-danger-subtle text-primary">Abandoned</a>
                                                    @elseif ($trans->Status == 'Pending')
                                                        <a class="badge bg-danger-subtle text-primary">Pending</a>
                                                    @else
                                                        <a class="badge bg-danger-subtle text-primary">Failed</a>
                                                    @endif
                                                </div>
                                            </td>
