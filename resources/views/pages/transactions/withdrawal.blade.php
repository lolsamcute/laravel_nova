                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <a href="">
                            ...
                            <h2 class="text-center">Settlements</h2><br>
                            <h6 class="text-center">See below all settlement transactions.</h6>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <span class="text-muted mb-3 lh-1 d-block">Total Settlements
                                                Released</span>
                                            <h4 class="mb-3">
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block">Number of Released
                                                Settlements</span>
                                            <h4 class="mb-3">
                                                <span class="counter-value"
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block">Number of
                                                Settlements Withheld</span>
                                            <h4 class="mb-3">
                                                <span class="counter-value"
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <ol class="breadcrumb m-0">
                                    <li>
                                        ...
                                        <a href="{{ route('withdrawal', ['filter' => 'all']) }}"
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('withdrawal', ['filter' => 'released']) }}"
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('withdrawal', ['filter' => 'withheld']) }}"
                                    ...
                                    @if (
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                {{ Str::limit($trans->CustomerFullname, 15) }}
                                            </td>
                                            <td> {{ Str::limit($trans->CustomerEmailAddress, 10) }}
                                            </td>
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="/viewStoreDetails/{{ $trans->Id }}"><img
