            ...
            <div class="page-content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <h2 class="text-center">Support</h2><br>
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block text-truncate">Requests</span>
                                            <h4 class="mb-3">
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block text-truncate">Approved
                                            </span>
                                            <h4 class="mb-3">
                                                <span class="counter-value" data-target="0">0</span>
                                            </h4>
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block text-truncate">Denied</span>
                                            <h4 class="mb-3">
                                                <span class="counter-value" data-target="0">0</span>
                                            </h4>
                                        </div>
