                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="invoice-title">
                                        ...
                                        <p class="mb-1">{{ $viewTicket->Heading ?? 'N/A' }}</p>
                                        <p class="mb-1">{!! $viewTicket->Message ?? 'N/A' !!}
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div>
                                                <h5 class="font-size-15 mb-3">Attachments (1)</h5>
                                                <h5 class="font-size-14 mb-2"><a href=""><img
                                                            src="/category.png" height="30" width="30">I found
                                                        peace</a></h5>
                                    ...
                                    <a href="/ticket/reply/{{ $viewTicket->Id }}"
                                        class="btn btn-primary waves-effect mt-4"><i class="mdi mdi-reply me-1"></i>
                                        Reply</a>
