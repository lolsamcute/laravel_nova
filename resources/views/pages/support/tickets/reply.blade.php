                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div
                                            ...
                                            <div class="col-sm-3">
                                                <p>Ticket ID</p>
                                                <label>{{ $viewTicket->TicketReference }}</label>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                @if ($viewTicket->Status == 'open')
                                                    <label><a
                                                            class="badge bg-success-subtle text-success">Open</a></label>
                                                @else
                                                    <label><a
                                                            class="badge bg-danger-subtle text-danger">Closed</a></label>
                                                @endif
                                            ...
                                            <div class="col-sm-3">
                                                <p>Deprtment</p>
                                                <label>{{ $viewTicket->Department }}</label>

                                            </div>

                                            <div class="col-sm-3">
                                                <p>Submitted Date</p>
                                                <label>{{ \Carbon\Carbon::parse($viewTicket->CreatedAt)->format('M jS Y, g:i A') }}</label>
                                    ...
                                    @foreach ($viewTickets as $viewTicket)
                                        <div class="invoice-title">
                                            <div class="d-flex align-items-center mb-4">
                                                <div class="flex-shrink-0 me-3">
                                                    @if ($viewTicket->BusinessLogo == null)
                                                        <img class="rounded-circle avatar-sm" src="/logo.svg"
                                                            alt="/logo.svg">
                                                    @else
                                                        <img class="rounded-circle avatar-sm"
                                                            src="{{ $viewTicket->BusinessLogo }}"
                                                            alt="{{ $viewTicket->BusinessLogo }}">
                                                    @endif

                                                </div>
                                                <div class="flex-grow-1">
                                                    <h5 class="font-size-14 mb-0">{{ $viewTicket->Fullname }}</h5>
                                                    <small
                                                        class="text-muted">{{ $viewTicket->Department ?? 'N/A' }}</small>
                                                </div>
                                            </div>



                                            <h5>{!! $viewTicket->Message ?? 'N/A' !!}</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div>
                                                    <h5 class="font-size-15 mb-3">Attachments ({{ $countAttachment }})
                                                    </h5>
                                                    @if ($countAttachment > 0)
                                                        <h5 class="font-size-14 mb-2"><a href=""><img
                                                                    src="/category.png" height="30"
                                                                    width="30">I
                                                                found
                                                                peace</a></h5>
                                                    @endif
                                    ...
                                    <form action="/ticket/reply/{{ $viewTicket->Id }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <textarea name="Message" id="ckeditor-classic"></textarea>

                                            </div>

                                        </div>

                                        <button type="submit" class="btn btn-primary waves-effect mt-4"><i
                                                class="mdi mdi-reply me-1"></i> Submit Response</button>
                                        <a href="javascript: void(0);" class="btn btn-secondary waves-effect mt-4"><i
                                                class="mdi mdi-reply me-1"></i> Back</a>
                                    </form>
