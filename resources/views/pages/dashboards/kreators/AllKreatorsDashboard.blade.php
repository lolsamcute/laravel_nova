            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <form method="GET" action="{{ route('filterKreatorsDashboard') }}">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <label><a href="/app/kreators">Kreator's Dashboard</a></label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-12">
                                    <div>
                                        <canvas id="myChart" height="340x"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Recent Kreators</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <form action="/get-filteredKreator" method="get" id="filter-formMe">
